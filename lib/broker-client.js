// This file is extraneous and can be deleted.
// This file is unused and can be deleted.--- START OF FILE lib/broker-client.ts ---
 ...
 */
export async function submitRequest<T>(service: string, operation: string, params: object = {}): Promise<T> {
    const request = {
        service,
        operation,
        params,
