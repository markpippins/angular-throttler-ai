...
// The BROKER_URL is sourced from environment variables to avoid hardcoding.
// It falls back to a default value for local development if the variable is not set.
