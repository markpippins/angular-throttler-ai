...
export class ElasticsearchFileSystemService implements FileSystemProvider {
  
  private notImplemented(): Promise<any> {
    return Promise.reject(new Error('This operation is not implemented for Elasticsearch file system.'));
  }
